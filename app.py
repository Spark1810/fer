...
# Load the classifier
classifier = joblib.load('crop_pred_rand.pkl')
...
def predict_fertilizer(n, p, k, temperature, humidity, ph):
    if any(val == "Type Here" or val == "" for val in [n, p, k, temperature, humidity, ph]):
...
def main():
    ...
    if choice == "HOME":
        ...
        st.write("SmartCrop is an Intelligent Crop Recommendation System...")
        time.sleep(3)
        ...
        if st.sidebar.checkbox("LOGIN"):
            if user == "Admin" and passwd == 'admin123':
                ...
                Nitrogen = st.text_input('Input your Nitrogen value Here:', "Type Here")
                ...
                if st.button("Predict"):
                    result = predict_fertilizer(Nitrogen, Phosphorus, Potassium, temperature, humidity, ph)
